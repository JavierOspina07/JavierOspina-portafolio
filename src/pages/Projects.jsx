    ...
    <div className='card-container'>
      <article className='card'>
        ...
        <div className='card_content'>
          ...
          <p className='card_description'>{t('projects.description')}</p>
      ...
      <article className='card'>
        ...
        <div className='card_content'>
          ...
          <span className='card_subtitle'>{t('galletica.subtitle')}</span>
          <p className='card_description'>{t('galletica.description')}</p>
          <div className='card_technologies'>
      ...
      <article className='card'>
        ...
        <div className='card_content'>
          ...
          <p className='card_description'>{t('climatic.description')}</p>
          <div className='card_technologies'>
            <i class='bx bxl-react'></i>
            <i class='bx bxl-html5'></i>
            <i class='bx bxl-css3'></i>
      ...
      <article className='card'>
        ...
        <div className='card_content'>
          ...
          <p className='card_description'>{t('RandM.description')}</p>
          <div className='card_technologies'>
            <i class='bx bxl-react'></i>
            <i class='bx bxl-html5'></i>
            <i class='bx bxl-css3'></i>
      ...
      <article className='card'>
        ...
        <div className='card_content'>
          ...
          <p className='card_description'>{t('User.description')}</p>
          <div className='card_technologies'>
            <i class='bx bxl-react'></i>
            <i class='bx bxl-html5'></i>
            <i class='bx bxl-css3'></i>
      ...
      <article className='card'>
        ...
        <div className='card_content'>
          ...
          <span className='card_subtitle'>{t('poke.subtitle')}</span>
          <p className='card_description'>{t('poke.description')}</p>
          <div className='card_technologies'>
            <i class='bx bxl-react'></i>
            <i class='bx bxl-html5'></i>
            <i class='bx bxl-css3'></i>
      ...
      <article className='card'>
        <div className='temporary_text'>
          ...
          <a
            href='https://javier-shop-react.netlify.app/'
            target='_blank'
            className='card-btn-page'
          >
            <i className='fa-solid fa-link'></i>
        ...
        <div className='card_content'>
          ...
          <span className='card_subtitle'>{t('tecn.subtitle')}</span>
          <p className='card_description'>{t('tecn.description')}</p>
          <i class='bx bxl-react'></i>
          <i class='bx bxl-html5'></i>
          <i class='bx bxl-css3'></i>
          <i class='bx bxl-javascript'></i>
